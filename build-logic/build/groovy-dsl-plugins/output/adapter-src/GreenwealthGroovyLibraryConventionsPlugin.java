...
/**
 * Precompiled greenwealth.groovy-library-conventions script plugin.
 **/
public class GreenwealthGroovyLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_GreenwealthGroovyLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_GreenwealthGroovyLibraryConventions").asSubclass(BasicScript.class);
