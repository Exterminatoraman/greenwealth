...
/**
 * Precompiled greenwealth.groovy-application-conventions script plugin.
 **/
public class GreenwealthGroovyApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_GreenwealthGroovyApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("greenwealth.groovy-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_GreenwealthGroovyApplicationConventions").asSubclass(BasicScript.class);
